...
rrdtool graph h2-spinsleep-1ms.0.svg \
--width 600 \
--height 200 \
--start 00:00 \
--end start+80seconds \
...
'DEF:dirty0=h2-spinsleep-1ms.rrd:dirty:MAX:start=1502983381:end=1502983461:step=1' \
'DEF:error=h2-spinsleep-1ms.rrd:error:MAX:start=1502983381:end=1502983461:step=1' \
'DEF:normal0=h2-spinsleep-1ms.rrd:normal:MAX:start=1502983381:end=1502983461:step=1' \
'SHIFT:10000x:-33781' \
'SHIFT:1000x:-33781' \
'SHIFT:100x:-33781' \
'SHIFT:10x:-33781' \
