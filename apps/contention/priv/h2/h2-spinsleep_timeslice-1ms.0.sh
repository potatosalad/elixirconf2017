...
rrdtool graph h2-spinsleep_timeslice-1ms.0.svg \
--width 600 \
--height 200 \
--start 00:00 \
--end start+66seconds \
...
'DEF:dirty0=h2-spinsleep_timeslice-1ms.rrd:dirty:MAX:start=1502983620:end=1502983686:step=1' \
'DEF:error=h2-spinsleep_timeslice-1ms.rrd:error:MAX:start=1502983620:end=1502983686:step=1' \
'DEF:normal0=h2-spinsleep_timeslice-1ms.rrd:normal:MAX:start=1502983620:end=1502983686:step=1' \
'SHIFT:10000x:-34020' \
'SHIFT:1000x:-34020' \
'SHIFT:100x:-34020' \
'SHIFT:10x:-34020' \
