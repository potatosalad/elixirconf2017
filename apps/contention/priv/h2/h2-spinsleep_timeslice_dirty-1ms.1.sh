...
rrdtool graph h2-spinsleep_timeslice_dirty-1ms.1.svg \
--width 600 \
--height 200 \
--start 00:00 \
--end start+68seconds \
...
'DEF:requests=h2-spinsleep_timeslice_dirty-1ms.rrd:requests:MAX:start=1502983965:end=1502984033:step=1' \
'SHIFT:10000x:-34365' \
'SHIFT:1000x:-34365' \
'SHIFT:100x:-34365' \
'SHIFT:10x:-34365' \
