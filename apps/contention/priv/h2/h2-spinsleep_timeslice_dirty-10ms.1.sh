...
rrdtool graph h2-spinsleep_timeslice_dirty-10ms.1.svg \
--width 600 \
--height 200 \
--start 00:00 \
--end start+68seconds \
...
'DEF:requests=h2-spinsleep_timeslice_dirty-10ms.rrd:requests:MAX:start=1502984659:end=1502984727:step=1' \
'SHIFT:10000x:-35059' \
'SHIFT:1000x:-35059' \
'SHIFT:100x:-35059' \
'SHIFT:10x:-35059' \
