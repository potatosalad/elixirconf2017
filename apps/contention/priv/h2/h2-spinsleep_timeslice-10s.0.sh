...
rrdtool graph h2-spinsleep_timeslice-10s.0.svg \
--width 600 \
--height 200 \
--start 00:00 \
...
'DEF:dirty0=h2-spinsleep_timeslice-10s.rrd:dirty:MAX:start=1502985471:end=1502985687:step=1' \
'DEF:error=h2-spinsleep_timeslice-10s.rrd:error:MAX:start=1502985471:end=1502985687:step=1' \
'DEF:normal0=h2-spinsleep_timeslice-10s.rrd:normal:MAX:start=1502985471:end=1502985687:step=1' \
'SHIFT:10000x:-35871' \
'SHIFT:1000x:-35871' \
'SHIFT:100x:-35871' \
'SHIFT:10x:-35871' \
