...
rrdtool graph cowboy-2.0.0-rc.1-stream.0.svg \
--width 600 \
--height 200 \
--start 00:00 \
...
--lower-limit -1 \
--rigid \
'DEF:dirty0=cowboy-2.0.0-rc.1-stream.rrd:dirty:MAX:start=1503068183:end=1503068483:step=1' \
'DEF:error=cowboy-2.0.0-rc.1-stream.rrd:error:MAX:start=1503068183:end=1503068483:step=1' \
'DEF:normal0=cowboy-2.0.0-rc.1-stream.rrd:normal:MAX:start=1503068183:end=1503068483:step=1' \
'SHIFT:dirty0:-32183' \
'SHIFT:error:-32183' \
'SHIFT:normal0:-32183' \
